...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, estoque: @produto.estoque, nome: @produto.nome, precocompra: @produto.precocompra, precovenda: @produto.precovenda }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { descricao: @produto.descricao, estoque: @produto.estoque, nome: @produto.nome, precocompra: @produto.precocompra, precovenda: @produto.precovenda }
    assert_redirected_to produto_path(assigns(:produto))
  end
