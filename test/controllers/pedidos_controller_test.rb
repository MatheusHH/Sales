...
class PedidosControllerTest < ActionController::TestCase
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post :create, pedido: { cliente_id: @pedido.cliente_id, observacao: @pedido.observacao }
    end
  ...
  test "should update pedido" do
    patch :update, id: @pedido, pedido: { cliente_id: @pedido.cliente_id, observacao: @pedido.observacao }
    assert_redirected_to pedido_path(assigns(:pedido))
  end
